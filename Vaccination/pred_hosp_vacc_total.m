function new_hosp = pred_hosp_vacc_total(para, T, D, N, V_T, V_PI, V_PS, HF, days_vaccinating, vacc_per_day, vacc_prop, tspan, y1, Month, strategy)
...
new_hosp = [y_diff(7) + y_diff(15) + y_diff(23)]; % Group 1, 2, 3, Combined
