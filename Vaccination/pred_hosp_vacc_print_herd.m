function percent_infected = pred_hosp_vacc_print_herd(para, T, D, N, V_T, V_PI, V_PS, HF, days_vaccinating, vacc_per_day, vacc_prop, tspan, y1, Month, strategy)
...
final_date = y(length(tspan), :);

percent_infected = [(N(1)-final_date(1))/N(1)*100, (N(2)-final_date(9))/N(2)*100, (N(3)-final_date(17))/N(3)*100, (N(1)+N(2)+N(3)-final_date(1)-final_date(9)-final_date(17))/(N(1)+N(2)+N(3))*100];
